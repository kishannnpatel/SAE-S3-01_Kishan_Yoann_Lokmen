...
public class TerrainVue {
    ...
    public TerrainVue(Terrain terrain, TilePane tilePane) {
        ...
        this.neigeImage = new Image(getClass().getResourceAsStream("/images/map/neige.png"));
        this.glaceImage = new Image(getClass().getResourceAsStream("/images/map/glace.png"));
