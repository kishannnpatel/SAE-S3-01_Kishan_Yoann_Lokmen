...
public class TableCraftVue {
    ...
    public TableCraftVue() {
        ...
        ImageView imagePioche = new ImageView(new Image(getClass().getResourceAsStream("/images/item/pioche.png")));
        imagePioche.setFitWidth(32);
        imagePioche.setFitHeight(32);

        ImageView imageDague = new ImageView(new Image(getClass().getResourceAsStream("/images/item/dague.png")));
        imageDague.setFitWidth(32);
        imageDague.setFitHeight(32);

        ImageView imageArc = new ImageView(new Image(getClass().getResourceAsStream("/images/item/arc.png")));
