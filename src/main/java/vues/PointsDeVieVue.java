...
public class PointsDeVieVue {
    ...
    public PointsDeVieVue(Pane zoneJeu, Sid sid) {
        ...
        this.flammePleine = new Image(getClass().getResourceAsStream("/images/vie/flamme.png"));
        this.flammeDemi = new Image(getClass().getResourceAsStream("/images/vie/demi_flamme.png"));
        this.flammeVide = new Image(getClass().getResourceAsStream("/images/vie/flamme_gris.png"));
