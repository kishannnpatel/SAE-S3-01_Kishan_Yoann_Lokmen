...
public class SidVue {
    ...
    public SidVue(Sid sid, Pane zoneJeu) {
        ...
        imageDroite = new Image(getClass().getResourceAsStream("/images/sid/sid_droite.png"));
        imageGauche = new Image(getClass().getResourceAsStream("/images/sid/sid_gauche.png"));
        imageDroiteRalenti = new Image(getClass().getResourceAsStream("/images/sid_droite_glace.png"));
        imageGaucheRalenti = new Image(getClass().getResourceAsStream("/images/sid_gauche_glace.png"));
        imageBase = new Image(getClass().getResourceAsStream("/images/sid/sid.png"));
